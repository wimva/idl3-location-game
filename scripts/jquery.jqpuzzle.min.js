...
(function ($) {
    ...
    return this.filter('img')
      .each(function () {
        ...
        var computedStyles = {
          ...
          piece: { border: getBorderWidth($dummyPiece) },
        };
        ...
        $srcImg.one('load', function () {
          ...
          var width = Math.floor(($( window ).width() - coveredWidth) / cols);
          var height = Math.floor(( ($( window ).width()*1.3) - coveredHeight) / rows);
  ...
  $(document).ready(function () {
    $('img.jqPuzzle').each(function () {
      var microFormat =
        /\bjqp(-[a-z]{2})?-r(\d)-c(\d)(-h(\d+))?(-s(\d+))?(-[A-Z]+)?\b/;
